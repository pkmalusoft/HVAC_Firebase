...
function reloaddocument() {
    ...
    if ($('#AcJournalID').val() > 0) {
        ...
        $.ajax({
            type: "POST",
            url: '/CompanyMaster/ListDocument',
            datatype: "html",

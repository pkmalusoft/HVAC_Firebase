...
namespace HVAC.DAL
{
    ...
    {
        //productOpening index
        //public static List<ProductOpeningVM> GetProductOpeningList(int BranchId)
        //{
        //    SqlCommand cmd = new SqlCommand();
        //    cmd.Connection = new SqlConnection(CommonFunctions.GetConnectionString);
        //    cmd.CommandText = "SP_ProductOpeningList";
        ...
        //    da.Fill(ds);
        //    List<ProductOpeningVM> objList = new List<ProductOpeningVM>();
        //    ProductOpeningVM obj;
        //    if (ds != null && ds.Tables.Count > 0)
        //    {
        //        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        //        {
        //            obj = new ProductOpeningVM();
        ...
        //            obj.ProductGroupName = ds.Tables[0].Rows[i]["ProductGroupName"].ToString();
        //            obj.ProductCategoryName = ds.Tables[0].Rows[i]["ProductCategoryName"].ToString();
        ...
        //            obj.OpeningValue = CommonFunctions.ParseDecimal(ds.Tables[0].Rows[i]["OpeningValue"].ToString());
        //            obj.ProductTypeName = ds.Tables[0].Rows[i]["ProductTypeName"].ToString();
        //            obj.ProductCode = ds.Tables[0].Rows[i]["BarCode"].ToString();
        ...
        public static List<AcHeadSelectAllVM> GetSalesHeadSelectAll(int BranchID)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = new SqlConnection(CommonFunctions.GetConnectionString);
            cmd.CommandText = "SP_GetSalesAcHeadList";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static List<AcHeadSelectAllVM> GetCostHeadSelectAll(int BranchID)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = new SqlConnection(CommonFunctions.GetConnectionString);
            cmd.CommandText = "SP_GetCostAcHeadList";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static List<AcJournalDetailVM> AcJournalDetailSelectByAcJournalID(int AcJournalID, string PaymentType)
        {
            ...
            if (ds != null && ds.Tables.Count > 0)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    obj.EmpName = ds.Tables[0].Rows[i]["EmployeeName"].ToString();
                    objList.Add(obj);
                }
            }
            return objList;
        ...
        public static List<AcOpeningMasterVm> GetAccountOpeningList(int FYearId, int BranchId)
        {
            ...
            if (ds != null && ds.Tables.Count > 0)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    obj.AcHeadID = CommonFunctions.ParseInt(ds.Tables[0].Rows[i]["AcHeadID"].ToString());
                    obj.AcHead = ds.Tables[0].Rows[i]["AcHead"].ToString();
                    obj.DebitAmount = ds.Tables[0].Rows[i]["DebitAmount"].ToString();
                    obj.CreditAmount = ds.Tables[0].Rows[i]["CreditAmount"].ToString();
                    objList.Add(obj);
                }
            }
            return objList;
        ...
        public static string CustomerInvoiceOpeningPosting(int fyearid, int branchid)
        {
            try
            {
                //string json = "";
                ...
                using (SqlConnection con = new SqlConnection(strConnString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand())
                    {
                        cmd.CommandText = "SP_CustomerInvoiceOpeningPosting " +  fyearid.ToString() + "," + branchid;//SP_AcInvoiceOpeningPosting
                        cmd.CommandType = CommandType.Text;
                        cmd.Connection = con;
                        con.Open();
                        cmd.ExecuteNonQuery();
        ...
        public static string SupplierInvoiceOpeningPosting(int fyearid, int branchid)
        {
            try
            {
                //string json = "";
                ...
                using (SqlConnection con = new SqlConnection(strConnString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand())
                    {
                        cmd.CommandText = "SP_SupplierInvoiceOpeningPosting " + fyearid.ToString() + "," + branchid;//SP_AcInvoiceOpeningPosting
                        cmd.CommandType = CommandType.Text;
                        cmd.Connection = con;
                        con.Open();
                        cmd.ExecuteNonQuery();
        ...
        public static YearEndProcessSearch GetYearEndProcessCustomerInv(string CustomerType, int YearId, int BranchId, int ProcessStatus,string CustomerIDs,int UserId=-1)
        {
            YearEndProcessSearch vm = new YearEndProcessSearch();
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = new SqlConnection(CommonFunctions.GetConnectionString);

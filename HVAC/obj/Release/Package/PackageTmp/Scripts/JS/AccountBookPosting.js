...
function CalculateTotal(index, type) {
    ...
    for (i = 0; i < maxrow; i++) {
        ...
        $('#spandebittotal').html(numberWithCommas(parseFloat(TotalDebit).toFixed(2)))
        $('#spancredittotal').html(numberWithCommas(parseFloat(TotalCredit).toFixed(2)))
    }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (index, value) {
                    ...
                    html += '<td class="textright"><input  readonly class="textright form-control" type="hidden"  onchange="CalculateTotal(' + i + ',1)" value=' + DebitAmount + ' name="acJournalDetailsList[' + i + '].DebitAmount" id="JDebitAmount_' + i + '" />' + numberWithCommas(DebitAmount) + '</td>';
                    html += '<td class="textright"><input readonly class="textright form-control" type="hidden"  onchange="CalculateTotal(' + i + ',2)" value=' + parseFloat(CreditAmount).toFixed(2) + ' name="acJournalDetailsList[' + i + '].CreditAmount" id="JCreditAmount_' + i + '" />' + numberWithCommas(DebitAmount) + '</td>';
                    //html +='<td>' + PaymentTypetext + '<input type="hidden" id="Paytype_' + i + '" value=' + PaymentType + ' name="acJournalDetailsList[' + i + '].IsDebit"></td>' +

...
function EditAWB(i) {
    ...
    $('#ConsignorAddress').val($('#hdnConsignorAddress_' + i).val());
    ...
    $('#ConsigneeAddress').val($('#hdnConsigneeAddress_' + i).val()),
    ...
    $('#CurrencyID').val($('#hdnCurrencyID_' + i).val());
...
function AddAWB(i,t) {
    ...
    var html = '<td>' +
        ...
        '<input type="hidden" id="hdnConsignorAddress_' + i + '" value="' + awbentry.ConsignorAddress + '" />' +
        ...
        '<input type="hidden" id="hdnConsigneeAddress_' + i + '" value="' + awbentry.ConsigneeAddress + '" />' +

...
function SaveCounterLogin() {
    ...
    var model = {
        CounterShiftID: $('#CounterShiftID').val(),
        CounterID: $('#CounterID').val(),
        ShiftID: $('#ShiftID').val(),
        CashAcHeadID: $('#CashAcHeadID').val(),
        CardAcHeadID: $('#CardAcHeadID').val()
    ...
    $.ajax({
        type: "POST",
        url: "/CounterShift/SaveCounterLogin/",
        datatype: "Json",
        data: {vm:model },
        success: function (response) {
            if (response.status == "OK") {
                ...
                window.location.href = "/CounterShift/Index";
